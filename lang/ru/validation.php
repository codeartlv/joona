...
return [
	...
	'password' => [
		'no_match' => 'Неверный текущий пароль.',
		'unsecure' => 'Введенный пароль недостаточно надежен.',
	],
	'password_hint' => [
		...
		'symbols' => 'Символы',
		'numbers' => 'Цифры',
		'length' => 'Длина не менее :length',
		'long' => 'Очень длинный пароль',
		'mixed' => 'Большие и маленькие буквы',
	],
