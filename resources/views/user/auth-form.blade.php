	...
	<div class="card card-auth" data-bind="admin.auth-form">
		<x-form action="{{route('joona.user.auth-process')}}" data-focus="email">
			...
			<div class="card-body">
				...
				<div class="block">
					<div class="form-group">
						<x-input :label="__('joona::user.email')" iconPrepend="mail" autocomplete="email" name="email" required="true" />
			...
			<div class="card-footer">
				<x-button type="submit" role="primary" disabled class="btn-block" :caption="__('joona::user.auth.button')" icon="key" />
